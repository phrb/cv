...
\newcommand{\workposition}[5]{
    ...
    \expandafter\ifstrequal\expandafter{#3}{}{}{& \textit{#3}\\} % Institution / Lab
    \expandafter\ifstrequal\expandafter{#4}{}{}{& \textit{#4}\\[4pt]} % University
    \expandafter\ifstrequal\expandafter{#5}{}{}{& {\small#5}\\[6pt]} % Description
}
...
\newcommand{\tableentrythree}[4]{
    #1 & #2 & #3\expandafter\ifstrequal\expandafter{#4}{}{\\}{\\[6pt]} % First the heading, then content, then a conditional insertion of whitespace if the third parameter has any content in it
}
